...
$_LANG['confirm_clear_cache'] = "Are you sure you want to clear all cache?";
...
$_LANG['domain_registration'] = "Domain Registration";
$_LANG['domain_transfer_initiated'] = "Domain transfer initiated";
$_LANG['domain_transfer_error'] = "Domain transfer error";
$_LANG['domain_registered'] = "Domain registered successfully";
$_LANG['domain_registration_error'] = "Domain registration error";
$_LANG['domain_renewed'] = "Domain renewed successfully";
$_LANG['domain_renewal_error'] = "Domain renewal error";
$_LANG['transfer_cancelled'] = "Transfer cancelled";
$_LANG['auth_code'] = "Authorization Code";
$_LANG['transfer_domain'] = "Transfer Domain";
$_LANG['register_domain'] = "Register Domain";
$_LANG['renew_domain'] = "Renew Domain";
$_LANG['check_availability'] = "Check Availability";
$_LANG['type_required'] = "Type is required";
$_LANG['name_required'] = "Name is required";
$_LANG['content_required'] = "Content is required";
$_LANG['priority_required'] = "Priority is required";
$_LANG['invalid_priority'] = "Invalid priority value";
$_LANG['registration_years'] = "Registration Years";
$_LANG['year'] = "Year";
$_LANG['years'] = "Years";
$_LANG['auth_code_help'] = "Get this code from your current registrar";
$_LANG['zone_settings'] = "Zone Settings";
$_LANG['zone_info'] = "Zone Information";
$_LANG['check_ssl'] = "Check SSL Status";
$_LANG['back'] = "Back";
$_LANG['availability_check_info'] = "Domain availability check is not directly supported via Cloudflare API. Please check domain availability through your registrar or Cloudflare dashboard.";
$_LANG['domain_exists'] = "Domain already exists in Cloudflare";
$_LANG['domain_may_be_available'] = "Domain may be available (check with registrar)";
$_LANG['availability_check_not_supported'] = "Domain availability check is not directly supported via API";
$_LANG['zone_settings_desc'] = "Manage Cloudflare settings for your domains";
$_LANG['select_domain'] = "Select Domain";
$_LANG['developer_mode'] = "Developer Mode";
$_LANG['enable_developer_mode'] = "Enable Developer Mode";
$_LANG['developer_mode_desc'] = "Temporarily bypass Cloudflare cache. Automatically expires after 3 hours.";
$_LANG['security_level'] = "Security Level";
$_LANG['security_off'] = "Off";
$_LANG['security_essentially_off'] = "Essentially Off";
$_LANG['security_low'] = "Low";
$_LANG['security_medium'] = "Medium";
$_LANG['security_high'] = "High";
$_LANG['security_under_attack'] = "I'm Under Attack!";
$_LANG['security_level_desc'] = "Set the security level for the zone. 'I'm Under Attack!' mode provides maximum protection.";
$_LANG['pause_cloudflare'] = "Pause Cloudflare";
$_LANG['pause_cloudflare_desc'] = "Pause Cloudflare";
$_LANG['pause_cloudflare_help'] = "When paused, Cloudflare will stop proxying traffic but DNS will continue to work.";
$_LANG['remove_from_cloudflare'] = "Remove from Cloudflare";
$_LANG['remove_zone'] = "Remove Zone from Cloudflare";
$_LANG['remove_zone_warning'] = "WARNING: This will permanently delete the zone from Cloudflare. This action cannot be undone!";
$_LANG['no_domains_found'] = "No domains found. Please sync domains first.";
$_LANG['zone_settings_controls'] = "Zone Settings Controls";
$_LANG['ssl_tls_settings'] = "SSL/TLS Settings";
$_LANG['ssl_tls_mode'] = "SSL/TLS Mode";
$_LANG['ssl_off'] = "Off (not secure)";
$_LANG['ssl_flexible'] = "Flexible";
$_LANG['ssl_full'] = "Full";
$_LANG['ssl_strict'] = "Full (Strict)";
$_LANG['ssl_mode_desc'] = "Select SSL/TLS encryption mode for your zone.";
$_LANG['ssl_verification_status'] = "Verification Status";